...
function StudentDetails() {
  ...
  return (
    <div style={backgroundStyle}>
      <main style={{ backgroundColor: "transparent", color: "#8B0000" }}>
        <h3 style={{ textAlign: "center", marginTop: "0.1px" }}>
          Student Details
        </h3>
        <div
        ...
        {searchResults.length > 0 && ( // Only render the table if there are search results
          ...
          >
            <table
              style={{
                width: "80%",
                border: "0.8px solid darkmagenta",
                ...
                {searchResults.map((student, index) => (
                  <tr key={index}>
                    ...
                    >
                      ...
                      {/* Add a new table cell for student ID */}
                      <td
             style={{
         padding: "8px",
         color: "darkmagenta",
...
>
           {student.studentId} {/* Use student.studentId here */}
                      ...
                      <Link
  to={`/homepage/StudentDetails/Studentdashboard/${student.studentId}`}
  state={student}
>
  <button
    style={{position: 'absolute', right: '150px', backgroundColor: '#6ba3e0', color: '#373e37',borderRadius: '3px', boxShadow: '4px 4px 8px rgba(0, 0, 0, 0.2)',padding: '5px 10px',}}
    onMouseEnter={(e) => {
      e.target.style.transform = "scale(1.1)";
    }}
    onMouseLeave={(e) => {
